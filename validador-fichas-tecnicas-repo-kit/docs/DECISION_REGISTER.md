...
| D-014 | Modelo/servidor de inferencia | pendiente | Fase 4 | Comparar Qwen3-8B BF16 frente a Qwen3-14B AWQ 4-bit sobre vLLM; conservar Qwen2.5 como alternativa de continuidad | ADR-0008 revisado 2026-09-07 con fuentes oficiales. Decisión preparada; requiere aceptación humana |
...
| D-027 | Materialización y uso de identificadores externos del maestro | cerrada para vínculo CIMA por CN | Antes de poblar `external_identifier` en REAL | Conservar FieldValue; vínculo sólo por CN literal exacto, único en ambos lados; no equiparar `*_IDEXTERNO`, CN y `nregistro` | ADR-0011 aceptado por instrucción del responsable; otros identificadores siguen fuera de alcance |
| D-029 | Jerarquía producto/autorización → presentación/CN → DCPF → DCP → DCSA | cerrada | Antes del rediseño del catálogo | Identidades separadas, vínculos tipados y composición 1..N | ADR-0012 aceptado por instrucción del responsable 2026-09-22 |
| D-030 | Representación interna del Código Nacional | cerrada en alcance conceptual | Antes de migrar identidades | Seis dígitos canónicos de trabajo más literal fuente intacto; control mediante regla versionada pendiente | ADR-0012; cálculo exacto del control pendiente de evidencia |
