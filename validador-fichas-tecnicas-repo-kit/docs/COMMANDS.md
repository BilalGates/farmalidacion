...
|---|---|---|
| `test` | suite backend, frontend e integración | parcial: `python -m unittest discover -s tests -v` |
| `lint` | estilo estático de Python y TypeScript | pendiente DEV-102/103 |
| `typecheck` | tipos de backend y frontend | pendiente DEV-102/103 |
